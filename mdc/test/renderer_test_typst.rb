...
require_relative '../lib/rendering/renderer_typst'
require_relative '../lib/rendering/line_renderer'
require_relative '../lib/rendering/line_renderer_typst'
...
# Test the parser
#
class RendererTestTypst < RendererTestBase
  ...
  def test_all
    renderer = Rendering::RendererTypst.new(nil, 'Java', '', '', '/tmp')
